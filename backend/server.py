        ...
        try:
            ...
            if _has_restaurant_search_intent(transcript):
                ...
                if suggestions:
                    ...
                    # If we have an event and no location yet, attach top suggestion.
            ...
            # Auto-execute: calendar events with enough detail
            if cal and actions.calendar_events:
                ...
                for ev in actions.calendar_events:
                    ...
                    # Infer end_time if missing (default 1 hour)
                    ...
                    # Conflict check / enrichment patch
                    if existing_for_day:
                        try:
            ...
            # Auto-execute: reminders -> calendar reminder events
            ...
            # Auto-execute: messages to send via iMessage
